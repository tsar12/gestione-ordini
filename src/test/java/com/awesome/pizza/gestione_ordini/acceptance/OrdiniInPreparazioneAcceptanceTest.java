...
public class OrdiniInPreparazioneAcceptanceTest extends AcceptanceTest {
  ...
  @Test
  void ordineInPreparazione_riceveChiamataOrdiniInPreparazione_ritornaListaOrdini() throws Exception {
    Long idOrdine = creaOrdine();

    String ordine = get("/in-preparazione")
